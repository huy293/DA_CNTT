            ...
            {loading ? (
              ...
              <div className="text-white space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p><strong>Ngày phát hành:</strong> {formatDate(seasonDetail.release_date)}</p>
                ...
                <div className="flex gap-3 mt-4">
                  ...
                  <Gradient_outline_Red
                    content={isFavorite(seasonDetail?.id) ? 'Đã thích' : 'Thêm danh sách'}
                    onClick={handleFavorite}
                    className={`px-4 py-2 rounded-lg ${isFavorite(seasonDetail?.id) ? 'bg-red-600' : 'bg-red-600'} text-white hover:bg-red-700`}
                    disabled={favLoading}
                  />
                </div>
              </div>
