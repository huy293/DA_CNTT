...
const PieChart = ({ data = [], title = "" }) => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="bg-gradient-to-br from-gray-50 to-purple-50 dark:from-gray-800 dark:to-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
